...
class TouchTerm(ctk.CTk):
    def __init__(self):
        ...
        self.configure(fg_color="#0A0A12") # Un albastru-negru foarte profund (vibe E-Sports)
        ...
        # ==========================================
        # FUNDAL ANIMAT CYBERPUNK (CANVAS)
        # ==========================================
    ...
    def init_animated_bg(self):
        """Inițializează particulele pentru fundalul animat (Matrix/Cyber rain)"""
        self.particles = []
        screen_w, screen_h = self.winfo_screenwidth(), self.winfo_screenheight()
        
        for _ in range(70): # Numărul de linii
            x = random.randint(0, screen_w)
            y = random.randint(-screen_h, screen_h)
            speed = random.uniform(1.0, 3.5)
            length = random.randint(50, 300)
            # Culoare subtilă de cyan/magenta închis
    ...
    def animate_bg(self):
        """Mișcă particulele pe fundal continuu"""
        self.canvas.delete("all")
        screen_h = self.winfo_screenheight()
        
        for p in self.particles:
            p[1] += p[2] # Coboară linia
            if p[1] > screen_h:
                p[1] = -p[3] # Resetează sus dacă iese din ecran
        ...
        self.after(30, self.animate_bg) # ~30 FPS pentru fluiditate
    ...
    def setup_frames(self):
        ...
        # Buton Copil (Aliniat cu Turcoaz - Jucător 1)
        ...
        # Buton Adult (Aliniat cu Magenta - Jucător 2)
        ...
        # Butoane Dificultate (Stilizate Sci-Fi Outline)
    ...
    def show_diff_screen(self):
        ...
        # Stilizare dinamică a culorilor pe baza profilului
        if self.selected_category == "MIXED":
            self.btn_medium.pack_forget() # Ascunde Medium
            # Acum au fundal transparent și același hover_color ca dificultățile normale!
